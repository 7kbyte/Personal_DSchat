...
THEME_CSS = r"""
:root{--bg:linear-gradient(160deg,#fef9f0 0%,#fce4c8 40%,#fad4a0 100%);--sidebar-bg:#f5e0c0;--surface:rgba(255,255,255,.92);--surface-secondary:rgba(250,240,225,.9);--user-bubble:rgba(255,224,178,.85);--ai-bubble:rgba(255,255,255,.9);--text:#1a1a1a;--sub:#8b7355;--border:#e0c8a8;--accent:#e67e22;--accent-hover:#d35400;--accent-soft:rgba(230,126,34,.12);--accent-alt:#f39c12;--on-accent:#fff;--input-bg:rgba(255,255,255,.92);--code-bg:#2c1810;--code-fg:#f0c8a0;--shadow:0 1px 3px rgba(0,0,0,.08);--danger:#e74c3c;--sidebar-footer:#b8936a}body[data-theme=sakura]{--bg:linear-gradient(160deg,#fef5f7 0%,#fce4ec 40%,#f8c8d8 100%);--sidebar-bg:#f5d5e0;--surface:rgba(255,255,255,.92);--surface-secondary:rgba(253,240,245,.9);--user-bubble:rgba(252,228,236,.85);--ai-bubble:rgba(255,255,255,.9);--text:#1a1a1a;--sub:#9e7777;--border:#e8c8d4;--accent:#e91e63;--accent-hover:#c2185b;--accent-soft:rgba(233,30,99,.12);--accent-alt:#ec407a;--on-accent:#fff;--input-bg:rgba(255,255,255,.92);--code-bg:#2d1520;--code-fg:#f0c0d0;--shadow:0 1px 3px rgba(0,0,0,.08);--danger:#e74c3c;--sidebar-footer:#c4909a}body[data-theme=ocean]{--bg:linear-gradient(160deg,#1e2d42 0%,#162535 40%,#0d1a2d 100%);--sidebar-bg:#0d1625;--surface:rgba(36,52,71,.94);--surface-secondary:rgba(30,49,68,.92);--user-bubble:rgba(26,82,118,.78);--ai-bubble:rgba(36,52,71,.88);--text:#dce4ec;--sub:#7f8c8d;--border:#263545;--accent:#3498db;--accent-hover:#2980b9;--accent-soft:rgba(52,152,219,.18);--accent-alt:#1abc9c;--on-accent:#fff;--input-bg:rgba(36,52,71,.92);--code-bg:#0a0f17;--code-fg:#c9d1d9;--shadow:0 1px 3px rgba(0,0,0,.5);--danger:#e74c3c;--sidebar-footer:#3d5568}body[data-theme=cosmic]{--bg:linear-gradient(160deg,#141020 0%,#0d0a18 40%,#080510 100%);--sidebar-bg:#06040c;--surface:rgba(26,26,26,.94);--surface-secondary:rgba(18,18,18,.92);--user-bubble:rgba(26,26,46,.82);--ai-bubble:rgba(22,33,62,.88);--text:#e0e0e0;--sub:#666;--border:#1c1c1c;--accent:#bb86fc;--accent-hover:#9b59b6;--accent-soft:rgba(187,134,252,.18);--accent-alt:#818cf8;--on-accent:#0d0d0d;--input-bg:rgba(22,33,62,.92);--code-bg:#000;--code-fg:#e0e0e0;--shadow:0 1px 3px rgba(0,0,0,.7);--danger:#cf6679;--sidebar-footer:#333}*{margin:0;padding:0;box-sizing:border-box}
